...
do
	...
	then
	    mri_surf2surf --srcsubject fsaverage5 --sval ${workdir}/onesample/${hemi}.RSFC.rPCC/${seed}/sig.mgh --hemi ${hemi} --cortex --trgsubject fsaverage --tval ${workdir}/fs1mm/${hemi}.${seed}.sig.nii.gz --noreshape --cortex
